...
var decoder = [...]uint16{
	...
	/*622*/ uint16(xSetOp), uint16(ORop),
	/*624*/ uint16(xReadSlashR),
	/*625*/ uint16(xArgRM16),
	/*626*/ uint16(xArgR16),
	/*627*/ uint16(xMatch),
	/*628*/ uint16(xSetOp), uint16(ORop),
	/*630*/ uint16(xReadSlashR),
	/*631*/ uint16(xArgRM32),
	/*632*/ uint16(xArgR32),
	/*633*/ uint16(xMatch),
	/*634*/ uint16(xCondDataSize), 622, 628, 638,
	/*638*/ uint16(xSetOp), uint16(ORop),
	/*640*/ uint16(xReadSlashR),
	/*641*/ uint16(xArgRM64),
	/*642*/ uint16(xArgR64),
	/*643*/ uint16(xMatch),
	/*644*/ uint16(xSetOp), uint16(ORop),
	...
	/*657*/ uint16(xSetOp), uint16(ORop),
	/*659*/ uint16(xReadSlashR),
	/*660*/ uint16(xArgR16),
	/*661*/ uint16(xArgRM16),
	/*662*/ uint16(xMatch),
	/*663*/ uint16(xSetOp), uint16(ORop),
	/*665*/ uint16(xReadSlashR),
	/*666*/ uint16(xArgR32),
	/*667*/ uint16(xArgRM32),
	/*668*/ uint16(xMatch),
	/*669*/ uint16(xCondDataSize), 657, 663, 673,
	/*673*/ uint16(xSetOp), uint16(ORop),
	/*675*/ uint16(xReadSlashR),
	/*676*/ uint16(xArgR64),
	/*677*/ uint16(xArgRM64),
	/*678*/ uint16(xMatch),
	/*679*/ uint16(xSetOp), uint16(ORop),
	/*681*/ uint16(xReadIb),
	/*682*/ uint16(xArgAL),
	...
	/*692*/ uint16(xSetOp), uint16(ORop),
	/*694*/ uint16(xReadIw),
	/*695*/ uint16(xArgAX),
	/*696*/ uint16(xArgImm16),
	/*697*/ uint16(xMatch),
	/*698*/ uint16(xSetOp), uint16(ORop),
	/*700*/ uint16(xReadId),
	/*701*/ uint16(xArgEAX),
	/*702*/ uint16(xArgImm32),
	/*703*/ uint16(xMatch),
	/*704*/ uint16(xCondDataSize), 692, 698, 708,
	/*708*/ uint16(xSetOp), uint16(ORop),
	/*710*/ uint16(xReadId),
	/*711*/ uint16(xArgRAX),
	...
	/*8262*/ uint16(xArgDS),
	/*8263*/ uint16(xMatch),
	/*8264*/ uint16(xSetOp), uint16(ANDop),
	...
	/*8347*/ uint16(xSetOp), uint16(ANDop),
	/*8349*/ uint16(xReadIw),
	/*8350*/ uint16(xArgAX),
	/*8351*/ uint16(xArgImm16),
	/*8352*/ uint16(xMatch),
	/*8353*/ uint16(xSetOp), uint16(ANDop),
	/*8355*/ uint16(xReadId),
	/*8356*/ uint16(xArgEAX),
	/*8357*/ uint16(xArgImm32),
	/*8358*/ uint16(xMatch),
	/*8359*/ uint16(xCondDataSize), 8347, 8353, 8363,
	/*8363*/ uint16(xSetOp), uint16(ANDop),
	/*8365*/ uint16(xReadId),
	/*8366*/ uint16(xArgRAX),
	...
	/*9266*/ uint16(xMatch),
	/*9267*/ uint16(xSetOp), uint16(ORop),
	/*9269*/ uint16(xReadIb),
	/*9270*/ uint16(xArgRM8),
	...
	/*9284*/ uint16(xMatch),
	/*9285*/ uint16(xSetOp), uint16(ANDop),
	/*9287*/ uint16(xReadIb),
	/*9288*/ uint16(xArgRM8),
	...
	/*12999*/ uint16(xMatch),
	/*13000*/ uint16(xSetOp), uint16(NOTop),
	...
	/*13069*/ uint16(xSetOp), uint16(NOTop),
	/*13071*/ uint16(xArgRM16),
	/*13072*/ uint16(xMatch),
	/*13073*/ uint16(xSetOp), uint16(NOTop),
	/*13075*/ uint16(xArgRM32),
	/*13076*/ uint16(xMatch),
	/*13077*/ uint16(xCondDataSize), 13069, 13073, 13081,
	/*13081*/ uint16(xSetOp), uint16(NOTop),
